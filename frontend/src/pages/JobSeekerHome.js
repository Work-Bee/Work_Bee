  ...
  return (
    <div>
      ...
      <section className="py-8 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 md:mb-12">
            <div className="inline-flex items-center justify-center p-2 md:p-3 bg-white rounded-full mb-3 md:mb-4 border-2 border-gray-800">
              <svg className="w-6 h-6 md:w-8 md:h-8 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
              </svg>
            </div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2 md:mb-4">Featured Jobs</h2>
            <p className="text-sm md:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center py-8 md:py-12">
              <svg className="mx-auto h-10 w-10 md:h-12 md:w-12 text-gray-400 mb-3 md:mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 6 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2V6" />
              </svg>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <Link
                ...
                className="group p-6 bg-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-200 border-2 border-gray-800"
              >
                <div className="text-center">
                  <div className="text-3xl mb-3">{category.icon}</div>
                  <h3 className="font-semibold text-gray-800 group-hover:text-gray-800 mb-1">{category.name}</h3>
            ...
            {[
              {
                ...
                color: { bg: 'bg-gray-100', text: 'text-gray-800', border: 'border-gray-800' }
              },
              {
                step: '2',
                title: 'Search & Apply',
                ...
                color: { bg: 'bg-gray-200', text: 'text-gray-800', border: 'border-gray-800' }
              },
              {
                step: '3',
                title: 'Get Hired',
                ...
                color: { bg: 'bg-gray-300', text: 'text-gray-800', border: 'border-gray-800' }
              },
            ].map((item) => (
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/profile" className="inline-flex items-center justify-center px-6 py-3 bg-white border-2 border-gray-800 text-gray-800 font-semibold rounded-xl hover:bg-gray-100 transition-all shadow-sm">
              <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
              Update Your Profile
