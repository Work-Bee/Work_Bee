...
const EmployerHome = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
            ...
            <div>
              ...
              <div className="hidden lg:block mb-8">
                <svg className="w-full max-w-md mx-auto" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <circle cx="80" cy="220" r="40" fill="#D1FAE5" opacity="0.5"/>
                  
                  {/* Main illustration - People hiring */}
                  <rect x="100" y="100" width="200" height="140" rx="12" fill="#FFFFFF" stroke="#E5E7EB" strokeWidth="2"/>
                  
                  {/* Desk */}
                  <rect x="120" y="180" width="160" height="8" rx="4" fill="#A78BFA"/>
                  
                  {/* Laptop */}
                  <rect x="150" y="155" width="100" height="60" rx="4" fill="#6B46C1"/>
                  <rect x="155" y="160" width="90" height="45" rx="2" fill="#F3F4F6"/>
                  <line x1="200" y1="160" x2="200" y2="205" stroke="#A78BFA" strokeWidth="2"/>
                  
                  {/* Person 1 */}
                  <circle cx="140" cy="140" r="12" fill="#10B981"/>
                  <rect x="130" y="152" width="20" height="25" rx="4" fill="#34D399"/>
                  
                  {/* Person 2 */}
                  <circle cx="260" cy="140" r="12" fill="#6B46C1"/>
                  <rect x="250" y="152" width="20" height="25" rx="4" fill="#A78BFA"/>
                  
                  {/* Documents/Applications flying */}
                  <rect x="80" y="80" width="30" height="40" rx="2" fill="#D1FAE5" stroke="#10B981" strokeWidth="1.5"/>
                  <rect x="290" y="60" width="30" height="40" rx="2" fill="#F3E8FF" stroke="#A78BFA" strokeWidth="1.5"/>
                  
                  {/* Checkmarks */}
                  <path d="M 90 95 L 95 100 L 105 88" stroke="#10B981" strokeWidth="2" fill="none" strokeLinecap="round"/>
                  <path d="M 300 75 L 305 80 L 315 68" stroke="#6B46C1" strokeWidth="2" fill="none" strokeLinecap="round"/>
                  
                  {/* Stars for success */}
                  <path d="M 350 120 L 352 126 L 358 126 L 353 130 L 355 136 L 350 132 L 345 136 L 347 130 L 342 126 L 348 126 Z" fill="#F59E0B"/>
                  <path d="M 60 100 L 62 104 L 66 104 L 63 107 L 64 111 L 60 108 L 56 111 L 57 107 L 54 104 L 58 104 Z" fill="#F59E0B"/>
                </svg>
              </div>
              
              <span className="inline-flex items-center px-4 py-2 rounded-full bg-purple-100 text-purple-700 text-sm font-semibold mb-6 border border-purple-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/employer/jobs/new" className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-500 to-green-500 text-white font-semibold rounded-xl hover:shadow-lg transition-all shadow-md">
                  <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
                  Post a New Job
                </Link>
                <Link to="/dashboard" className="inline-flex items-center justify-center px-6 py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all shadow-sm">
                  Open Dashboard
                </Link>
              </div>
            </div>
            <div className="relative">
              <div className="absolute -inset-6 bg-purple-200/30 rounded-3xl blur-3xl"></div>
              <div className="relative bg-white text-gray-900 rounded-3xl shadow-2xl p-8 space-y-6 border border-purple-100">
                <div>
                  <h2 className="text-xl font-semibold text-purple-600 mb-3">Hiring snapshot</h2>
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={item.label} className="rounded-2xl border border-purple-200 bg-purple-50/50 p-4">
                ...
                <div className="flex items-start space-x-2 bg-green-50 border border-green-200 rounded-xl p-4">
      ...
      <div className="relative h-16 bg-gradient-to-r from-purple-100 to-green-100">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="relative bg-gradient-to-br from-purple-50 via-white to-green-50 rounded-2xl border-2 border-dashed border-purple-200 p-12 text-center overflow-hidden">
              {/* Decorative background circles */}
              <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-100 to-green-100 rounded-full opacity-40 blur-2xl -translate-y-1/2 translate-x-1/2"></div>
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-green-100 to-purple-100 rounded-full opacity-40 blur-xl translate-y-1/2 -translate-x-1/2"></div>
              
              {/* Decorative floating elements */}
              <div className="absolute top-8 left-1/4 w-3 h-3 bg-purple-300 rounded-full animate-pulse"></div>
              <div className="absolute top-16 right-1/3 w-2 h-2 bg-green-300 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
              <div className="absolute bottom-12 right-1/4 w-2.5 h-2.5 bg-purple-400 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
              
              <div className="relative z-10">
                {/* Icon illustration */}
                <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-purple-500 to-green-500 rounded-full mb-6 shadow-lg">
                  <svg className="w-12 h-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                
                <h3 className="text-2xl font-bold text-gray-900 mb-3">You haven&apos;t posted any jobs yet</h3>
                ...
                <Link to="/employer/jobs/new" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-green-500 text-white font-semibold rounded-xl hover:shadow-lg transition-all shadow-md">
                  <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
      ...
      <section className="bg-gradient-to-r from-purple-50 via-green-50 to-blue-50 py-16 relative overflow-hidden">
        {/* Decorative elements */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <svg className="w-full max-w-md mx-auto" viewBox="0 0 400 350" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Clock hands */}
                <line x1="200" y1="175" x2="200" y2="100" stroke="#6B46C1" strokeWidth="4" strokeLinecap="round"/>
                <line x1="200" y1="175" x2="250" y2="175" stroke="#10B981" strokeWidth="4" strokeLinecap="round"/>
                <circle cx="200" cy="175" r="8" fill="#F59E0B"/>
                
                {/* Speed lines */}
                <path d="M 280 130 L 320 110" stroke="#A78BFA" strokeWidth="3" strokeLinecap="round"/>
                <path d="M 290 190 L 330 200" stroke="#34D399" strokeWidth="3" strokeLinecap="round"/>
                <path d="M 270 220 L 300 250" stroke="#A78BFA" strokeWidth="3" strokeLinecap="round"/>
                
                {/* People icons around */}
                <circle cx="120" cy="80" r="20" fill="#6B46C1"/>
                <rect x="107" y="100" width="26" height="30" rx="5" fill="#A78BFA"/>
                
                <circle cx="280" cy="90" r="20" fill="#10B981"/>
                <rect x="267" y="110" width="26" height="30" rx="5" fill="#34D399"/>
                
                <circle cx="100" cy="260" r="20" fill="#10B981"/>
                <rect x="87" y="280" width="26" height="30" rx="5" fill="#34D399"/>
                
                <circle cx="300" cy="250" r="20" fill="#6B46C1"/>
                <rect x="287" y="270" width="26" height="30" rx="5" fill="#A78BFA"/>
                ...
                <rect x="60" y="140" width="25" height="35" rx="3" fill="#F3E8FF" stroke="#A78BFA" strokeWidth="2"/>
                <line x1="67" y1="150" x2="78" y2="150" stroke="#A78BFA" strokeWidth="1.5"/>
                <line x1="67" y1="157" x2="78" y2="157" stroke="#A78BFA" strokeWidth="1.5"/>
                
                <rect x="315" y="160" width="25" height="35" rx="3" fill="#D1FAE5" stroke="#10B981" strokeWidth="2"/>
                <line x1="322" y1="170" x2="333" y2="170" stroke="#10B981" strokeWidth="1.5"/>
                <line x1="322" y1="177" x2="333" y2="177" stroke="#10B981" strokeWidth="1.5"/>
                
                {/* Lightning bolt for speed */}
                <path d="M 200 40 L 185 60 L 200 60 L 190 85" fill="#F59E0B" stroke="#F59E0B" strokeWidth="2" strokeLinejoin="round"/>
              </svg>
            </div>
            
            {/* Content */}
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-green-500 rounded-full mb-6 shadow-lg lg:mx-0 mx-auto">
                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Need to hire quickly?</h2>
