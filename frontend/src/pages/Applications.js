...
const Applications = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-6 md:py-10 lg:py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">My Applications</h1>
          <p className="text-sm md:text-base text-gray-600">Track the status of every job you have applied to.</p>
        </div>

        {error ? (
          <div className="bg-white border border-red-100 text-red-700 rounded-xl p-4 md:p-6 text-center">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6 md:p-12 text-center">
            ...
            <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-2">You haven't applied to any jobs yet</h2>
            <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6">Browse open positions and apply with your resume to track them here.</p>
            ...
            {applications.map((application) => {
              ...
              return (
                <div key={application._id} className="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden hover:shadow-md transition-shadow">
                  {/* Header Section */}
                  <div className="bg-gradient-to-r from-primary-50 to-blue-50 px-4 md:px-6 py-3 md:py-4 border-b border-gray-200">
                    <div className="flex items-start justify-between gap-3 md:gap-4">
                      <div className="flex items-start gap-2 md:gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <h2 className="text-base md:text-lg font-semibold text-gray-800 mb-1 leading-tight">{job.title}</h2>
                          <p className="text-xs md:text-sm text-primary-700 font-medium">{companyName}</p>
                        </div>
                      </div>
                      <div className="flex-shrink-0">
                        <span className={`px-2 md:px-3 py-1 rounded-lg text-[10px] md:text-xs font-semibold whitespace-nowrap ${statusClass}`}>
                  ...
                  <div className="px-4 md:px-6 py-3 md:py-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3 text-xs md:text-sm mb-3 md:mb-4">
                    ...
                    {application.coverLetter && (
                      <div className="mt-3 md:mt-4 bg-gray-50 border border-gray-100 rounded-lg p-3 md:p-4">
                        <h3 className="text-[10px] md:text-xs font-semibold text-gray-700 mb-2 flex items-center gap-2">
                          <svg className="w-3.5 h-3.5 md:w-4 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                          Cover Letter
                        </h3>
                        <p className="text-xs md:text-sm text-gray-600 whitespace-pre-line max-h-24 md:max-h-32 overflow-y-auto">
                          {application.coverLetter}
                        </p>
                      </div>
                    )}
                  ...
                  {/* Footer Actions */}
                  <div className="px-4 md:px-6 py-3 md:py-4 bg-gray-50 border-t border-gray-100 flex flex-wrap items-center gap-2">
              ...
              >
                ...
                <div className="px-4 md:px-6 py-3 md:py-4 border-b border-gray-200 flex items-center justify-between">
                  <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <h3 className="text-base md:text-lg font-semibold text-gray-800">Confirm Deletion</h3>
                  </div>
                  <button
                    onClick={() => setShowDeleteConfirm(null)}
                ...
                <div className="px-4 md:px-6 py-4 md:py-5">
                  ...
                  <p className="text-base md:text-lg font-semibold text-gray-800 mb-3 md:mb-4">
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-2.5 md:p-3">
                    <p className="text-xs md:text-sm text-amber-800">
                      <svg className="w-3.5 h-3.5 md:w-4 md:h-4 inline mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                {/* Footer */}
                <div className="px-4 md:px-6 py-3 md:py-4 bg-gray-50 rounded-b-xl flex flex-col-reverse sm:flex-row gap-2 sm:justify-end">
                  <button
                    onClick={() => setShowDeleteConfirm(null)}
                    className="btn btn-outline btn-sm md:btn-md w-full sm:w-auto"
                  ...
                  <button
                    ...
                    disabled={deletingId === showDeleteConfirm}
                    className="btn btn-sm md:btn-md bg-red-600 text-white hover:bg-red-700 border-red-600 hover:border-red-700 w-full sm:w-auto"
                  >
                    {deletingId === showDeleteConfirm ? (
                      ...
                      <span className="text-sm md:text-base">Delete Application</span>
                    )}
                  </button>
                </div>
              </div>
