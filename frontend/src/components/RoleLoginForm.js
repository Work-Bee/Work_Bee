          ...
          {config.registerLink ? (
            <>
              <p className="mt-2 text-center text-sm text-gray-600">
                New here?{' '}
                <Link to={config.registerLink} className="font-medium text-primary-600 hover:text-primary-500">
                  {config.registerText}
                </Link>
              </p>
              {config.helperText && (
                <p className="mt-1 text-center text-xs text-gray-500">{config.helperText}</p>
              )}
            </>
          ) : (
            <p className="mt-2 text-center text-sm text-gray-600">{config.helperText}</p>
          )}
